...
var ANALYTICS_DEMO = {
  insights: [
    ...
    'Кофе навынос: 14 раз за месяц на 4 060₽ — по чеку незаметно.',
    'Откладываешь 38% дохода — это здорово, держи планку.'
  ],
  recommendations: [
    'Кафе/Рест выросла на 90% (+10 110₽). Вернёшь к прежнему уровню — это 10 110₽/мес, 121 320₽ за год.',
    'Подписки — 3 067₽/мес, а за год это 36 804₽. Пройдись по списку и отмени то, чем не пользуешься.',
    'Кофе навынос — 14 раз на 4 060₽ (48 720₽/год). Срезав вдвое, оставишь у себя 2 030₽/мес.'
  ]
};
