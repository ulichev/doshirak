...
{"insights":[{"emoji":"☕","text":"..."},{"emoji":"📈","text":"..."}]}
    ...
    const resp = await fetch('https://api.groq.com/openai/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: 'system',
            content: 'Ты личный финансовый аналитик. Тебе дают УЖЕ ПОСЧИТАННЫЕ факты о тратах — выбери самое важное и сформулируй кратко и по-человечески на русском. НИКОГДА не выдумывай числа. Отвечай строго JSON-объектом.'
          },
