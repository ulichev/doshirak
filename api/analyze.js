...
- Если данных мало — дай 1-2 СИЛЬНЫХ инсайта. Лучше два по делу, чем три, где третий — пересказ одной траты.
...
- ОБЪЯСНЯЙ, а не пересказывай. НЕ выдавай за инсайт пересказ одной траты («1 968₽ потрачено на «Транспорт»») или голую сумму («7 265₽ — Подарки»). Инсайт = доля, частота, сравнение или вывод. Хорошо: «58% трат за месяц — разовые «Подарки», по чеку незаметно».
