...
Как писать (стиль):
- Обращайся на «ты», по-дружески, без канцелярита и без оценочных эпитетов («необычная», «тревожная», «шокирующая»).
- Одна строка — одна мысль, коротко (до ~18 слов). Начинай с числа или факта.
- Инсайты бери из ФАКТОВ, выбери 2-3 самых важных. Хотя бы один построй на КОММЕНТАРИЯХ, если они есть (конкретно: «доставка», «кофе», «такси»).
- Рекомендации бери из ВОЗМОЖНЫХ ДЕЙСТВИЙ — перескажи их короче, НЕ меняя смысл и числа. Если действие про экономию — оставь сумму экономии; если про превышенный бюджет — оставь смысл «притормози / пересмотри», без обещаний «вернёшь».

Пример тона и длины (НЕ копируй текст и числа, framings бывают разные):
ИНСАЙТЫ
Доставка съела 9 400₽ — вдвое больше, чем месяц назад.
РЕКОМЕНДАЦИИ
Сократи доставку вдвое — это ~4 700₽ в месяц.
Бюджет уже превышен на 5 000₽: до конца месяца притормози необязательное.

Жёсткие правила:
- Только числа из данных выше. НИКОГДА не называй потраченное или перерасход «экономией»/«вернёшь» — экономия бывает только там, где она прямо названа в действии.
